...
import PrevArrowIcon from "../app/assets/pagenate-prev-arrow-icon-inactive_1.svg";
import NextArrowIcon from "../app/assets/pagenate-prev-arrow-icon-inactive_2.svg";
import { useRef, useEffect, useState } from "react";
import "../app/css/gnb_mobile.css";
        ...
        {menus.map((menu, index) => (
          <a
            ...
            style={{
              ...
              marginLeft: index === 0 ? `${(dWidth - 180) / 2}px` : "",
